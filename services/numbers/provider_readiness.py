...
_POLICY: dict[str, ProviderReadiness] = {
    ...
    "pvapins": ProviderReadiness(
        ...
        webhook_verified=False,
        reason="Supplied docs are polling-first; no confirmed provider webhook support yet.",
    ),
    "vaksms": ProviderReadiness(
        ...
        webhook_documented=False,
        webhook_verified=False,
        reason="Reviewed docs show polling/status APIs only; no confirmed provider webhook support yet.",
    ),
    "smspool": ProviderReadiness(
        ...
        webhook_documented=False,
        webhook_verified=False,
        reason="Reviewed Postman collection has polling APIs only; no confirmed provider webhook support yet.",
    ),
}
