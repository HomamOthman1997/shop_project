(() => {
  ...
  const EN = {
    ...
    "الأمان": "Security",
    "تغيير كلمة مرور حساب الموقع.": "Change your website account password.",
    ...
    "جواز سفر": "Passport",
    "تتم المراجعة حالياً من بياناتك الأساسية، وقد يطلب الدعم وثائق إضافية عند الحاجة.": "Review currently uses your basic details, and support may request additional documents when needed.",
    "إرسال طلب المراجعة": "Submit review request",
    "جاري إرسال طلب مراجعة الهوية...": "Submitting identity review request...",
    "تم إرسال طلب مراجعة الهوية.": "Identity review request submitted.",
    ...
    "انتهت الجلسة. سجّل دخولك مرة أخرى للمتابعة.": "Your session expired. Sign in again to continue.",
    "يجب تأكيد البريد الإلكتروني قبل تنفيذ هذا الإجراء.": "You must verify your email before performing this action.",
    "هذه الصفحة مخصصة لحساب المالك فقط.": "This page is for the owner account only.",
    "هذا الإجراء يحتاج صلاحية API أو جلسة موقع مفعّلة.": "This action requires API permission or an active website session.",
